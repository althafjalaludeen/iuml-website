...
type KeralaHistoryEntryCardProps = {
  entry: KeralaHistoryEntry;
  isLast?: boolean;
};
...
const sourceTypeLabels: Record<string, string> = {
  ...
  parliamentary: "Kerala Legislature / Parliamentary Record",
  independent: "Independent Reporting",
  academic: "Academic Research",
};

export function KeralaHistoryEntryCard({
  entry,
  isLast = false,
}: KeralaHistoryEntryCardProps) {
  const sources = getKeralaSourcesByIds(entry.sourceIds);
